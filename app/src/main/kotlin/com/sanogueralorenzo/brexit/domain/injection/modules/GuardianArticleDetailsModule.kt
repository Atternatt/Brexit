...
class GuardianArticleDetailsModule {
    ...
    @Provides
    fun provideArticleDetailsRepository(articleDetailsApi: ArticleDetailsApi, local: Local): ArticleDetailsRepository = ArticleDetailsRepository(articleDetailsApi, local)
