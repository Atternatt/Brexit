...
class GuardianAdapter(listener: OnArticleClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    init {
        delegateAdapters.put(AdapterConstants.WEEK, WeekDelegateAdapter(listener))
